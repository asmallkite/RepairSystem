...
<div id="container" >
<form action="../addToRepairServlet?service=delete" target="_self"
...
<tr>
  ...
  <td style="width:350px"><input type="text" name="to_repair_price"></td>
    ...
    <div>
        ...
        <input type="button" name="Delete" value="删除" onclick=del() background-color=" #9AD0D8" style="height:40px;width:80px; background:#9AD0D8"/>
        </div>
