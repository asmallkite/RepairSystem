...
<div id="container">
<form action="handleAcountServlet?service=find2" target="_self"
 ...
 <% Count Display = (Count)request.getAttribute("findCou_another"); %>
         <table width="589" bordercolor="#66CCCC"  border="0">
        <tr>
            <th  bgcolor="#9AD0D8">维修编号:</th>
            <td><input type="text" name="repair_number" value =<%=Display.getSe_repair_number() %>></td>
        </tr>
        <tr>
            <th  bgcolor="#9AD0D8">维修费用:</th>
            <td><input type="text" name="se_repair_cost" value =<%=Display.getSe_repair_cast()  %>></td>
        </tr>
        <tr>
            <th bgcolor="#9AD0D8">材料费用:</th>
            <td ><input type="text" name="se_meterial_cost"  value =<%=Display.getSe_material_cast()%>></td>
        </tr>
        <tr>
            <th  bgcolor="#9AD0D8">维修时间:</th>
            <td style="width:350px"><input type="text" name="se_time" value =<%=Display.getSe_time()%>></td>
        </tr>
        <tr>
      <th  bgcolor="#9AD0D8">注意事项:</th>
      <td style="width:350px"><input type="text" name="se_attention" value =<%=Display.getSe_attention() %>></td>
        </tr>
    ...
    <div id=kong3>
    <li><a href="/Repair/account/AccountInquire.jsp">返回</a></li>
    </div>
            </table>
