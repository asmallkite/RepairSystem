...
<div id="container">
<form action="../repairServlet?service=update" target="_self"
...
<div id="content"><table background="table20.jpg"   border="0" cellspacing="0">
<tr>
...
<tr>
  ...
  <td>  <select name="repair_use_device" id="repair_use_device">   
...
<div id=Button3></div>
       <input type="button" name="Submit" value="修改" onclick=pass() background-color=" #9AD0D8" style="height:40px;width:80px; background:#9AD0D8"/>
